      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-center space-y-2 pt-2">
          <p className="text-xs text-muted-foreground">
            We&apos;ll request access to your repositories to analyze commit history.
          </p>
          <p className="text-xs text-muted-foreground">
            Required permissions: <code className="bg-muted px-1 rounded">repo</code> and <code className="bg-muted px-1 rounded">read:user</code>
          </p>
        </div>
